...
#' The data is generated according to a location-shift Gaussian model 
...
#' and one fixed-effect and a Gaussian error.
#' The variable nobs is the number of units and year is the panel number.
#' 
#'
#' @docType data
#'
